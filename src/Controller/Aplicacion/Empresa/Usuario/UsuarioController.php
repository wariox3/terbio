...
class UsuarioController extends AbstractController
{
    ...
    public function nuevo(Request $request, $id,  EntityManagerInterface $em)
    {
        ...
        $form = $this->createFormBuilder()
            ...
            ->add('gestionTranporte', CheckboxType::class, array('data' => $arUsuario->isGestionTranporte(), 'required' => false))
            ->add('guiaNuevo', CheckboxType::class, array('data' => $arUsuario->isGuiaNuevo(), 'required' => false))
