...
//                $formato = new CertificadoLaboral();
...
//            }
        ...
        $arContratos = FuncionesController::consumirApi($arUsuario->getEmpresaRel(), $parametros, '/recursohumano/api/contrato');
        return $this->render('aplicacion/empleado/certificado/laboral.html.twig', [
